...
XPCOMUtils.defineLazyGetter(this, "toolStrings", () =>
  Services.strings.createBundle("chrome://fxos-l10n-mock/locale/strings.properties"));
...
XPCOMUtils.defineLazyGetter(this, "toolDefinition", () => ({
  ...
  build: function(iframeWindow, toolbox) {
    Cu.import("chrome://fxos-l10n-mock/content/panel.js");
    let panel = new MockL10nPanel(iframeWindow, toolbox);
    return panel.open();
  }
}));
